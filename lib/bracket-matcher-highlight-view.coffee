...
module.exports =
class BracketMatcherHighlightView
  constructor: (@editor, editorElement) ->
    ...
    @subscriptions.add atom.commands.add editorElement, 'bracket-matcher-highlight:go-to-matching-bracket', =>
      @goToMatchingPair()

    @subscriptions.add atom.commands.add editorElement, 'bracket-matcher-highlight:go-to-enclosing-bracket', =>
      @goToEnclosingPair()

    @subscriptions.add atom.commands.add editorElement, 'bracket-matcher-highlight:select-inside-brackets', =>
      @selectInsidePair()

    @subscriptions.add atom.commands.add editorElement, 'bracket-matcher-highlight:close-tag', =>
      @closeTag()

    @subscriptions.add atom.commands.add editorElement, 'bracket-matcher-highlight:remove-matching-brackets', =>
  ...
  createMarker: (bufferRange) ->
    ...
    @editor.decorateMarker(marker, type: 'highlight', class: 'bracket-matcher-highlight', deprecatedRegionClass: 'bracket-matcher-highlight')
    marker
